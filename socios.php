...
class Socio {
   ...
   public function getCooperativaId() { return $this->cooperativa_id; }
   ...
   // ----- Setters -----
   public function setCooperativaId($cooperativa_id) { $this->cooperativa_id = $cooperativa_id; }
   ...
   public function guardar() {
      ...
      if ($this->id) {
         ...
         $sql = 'INSERT INTO ' . self::TABLA . ' 
            (cooperativa_id, nombre, documento, telefono, email, fecha_ingreso, activo)
            VALUES (:cooperativa_id, :nombre, :documento, :telefono, :email, :fecha_ingreso, :activo)';
         $consulta = $Conexion->prepare($sql);
      }
